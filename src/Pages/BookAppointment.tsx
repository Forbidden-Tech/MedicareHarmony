...
export default function BookAppointment() {
  ...
  const appointmentTypes = [
    'Consultation', 'Surgery', 'Follow-up', 'Emergency', 'Check-up', 'Specialist Referral'
  ];
  ...
  const filteredDoctors = doctors.filter(
    doc => !formData.department || doc.specialisation === formData.department
  );
      ...
      <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-emerald-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-gray-600 mb-8 max-w-md">
            Thank you for booking with MediCare. We'll confirm your appointment shortly via email or phone.
          </p>
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8 text-left max-w-md mx-auto">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium">{formData.appointment_type}</span>
              </div>
              <div className="flex justify-between">
    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-emerald-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-gray-600">Fill in your details and we'll confirm your booking</p>
        </motion.div>
          ...
          <div className="flex items-center gap-4">
            {[1, 2, 3].map((s) => (
              <React.Fragment key={s}>
                ...
                {s < 3 && (
                  <div className={`w-16 h-1 rounded ${step > s ? 'bg-teal-600' : 'bg-gray-200'}`} />
                )}
              </React.Fragment>
            ))}
          </div>
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">What type of appointment do you need?</p>
                  </div>
                </div>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        {filteredDoctors.map(doc => (
                          <SelectItem key={doc.id} value={`${doc.title} ${doc.full_name}`}>
              ...
              >
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        <Button variant="outline" className="w-full h-12 justify-start text-left font-normal">
                          ...
                          {formData.date ? format(formData.date, 'dd MMMM yyyy') : 'Select a date'}
                        </Button>
                      </PopoverTrigger>
                ...
                <div className="bg-gray-50 rounded-xl p-4 mt-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3 text-sm">
                    ...
                    <div>
                      <span className="text-gray-500">Type:</span>
                      <span className="ml-2 font-medium">{formData.appointment_type}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Department:</span>
                    ...
                    {formData.doctor_name && (
                      <div>
                        <span className="text-gray-500">Doctor:</span>
                        <span className="ml-2 font-medium">{formData.doctor_name}</span>
                      </div>
                    )}
                  </div>
                </div>
        ...
        <p className="text-center text-gray-500 text-sm mt-6">
          Need immediate assistance? Call us at <a href="tel:+27123456789" className="text-teal-600 font-medium">+27 12 345 6789</a>
        </p>
      </div>
    </div>
  );
