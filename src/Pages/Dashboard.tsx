...
type StatKey = "upcoming" | "records" | "pendingBills" | "amountDue";
...
export default function Dashboard() {
  ...
  const stats: StatConfig[] = [
    ...
    },
    {
      key: "amountDue",
      label: "Amount Due",
      value: `R${totalOwed.toLocaleString()}`,
      Icon: Activity,
      bgClass: "bg-red-100",
        ...
        <aside className="hidden lg:block w-64 bg-white border-r min-h-[calc(100vh-4rem)] p-4">
          ...
          <div className="mt-8 p-4 bg-gradient-to-br from-teal-500 to-emerald-600 rounded-2xl text-white">
            ...
            <Link to={createPageUrl("HealthChat")}>
              <Button className="bg-white text-teal-600 hover:bg-teal-50 w-full" size="sm">
                  ...
                  {upcomingAppointments.length === 0 ? (
                    ...
                    upcomingAppointments.map((apt) => (
                      ...
                      >
                        ...
                        <Badge className={getStatusClasses(apt.status)}>
                          {apt.status}
                        </Badge>
                      </div>
                    ))
                  ...
                  {invoices.length === 0 ? (
                    ...
                    invoices.slice(0, 3).map((inv) => (
                      ...
                      >
                        ...
                        <Badge className={getStatusClasses(inv.status)}>
                          {inv.status}
                        </Badge>
                      </div>
                    ))
